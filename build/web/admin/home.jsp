<%-- 
    Document   : home
    Created on : Mar 12, 2022, 8:08:03 PM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Quản lí bình luận</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin/comment">Xem bình luận</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Quản lí Tag</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Xem thẻ</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="${pageContext.request.contextPath}/admin/js/datatables-simple-demo.js"></script>
         <script>
            <%View v = udb.getview();%>
            setView('<%= v.getMo()%>', '<%= v.getTu()%>', '<%= v.getWe()%>', '<%= v.getTh()%>', '<%= v.getFr()%>', '<%= v.getSa()%>', '<%= v.getSu()%>')
        </script>
