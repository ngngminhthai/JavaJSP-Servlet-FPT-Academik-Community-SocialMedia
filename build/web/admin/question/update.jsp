<%-- 
    Document   : update
    Created on : Mar 13, 2022, 4:21:00 PM
    Author     : Admin
--%>
...
<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head>
    ...
    <body class="sb-nav-fixed">
                            ...
                            <div class="col-md-12 border-right">
                                <div class="p-3 py-5">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h4 class="text-right">Cập nhật bài viết</h4>
                                    </div>
                                    <form method="post" action="UpdatePost">


                                        <div class="row mt-3">
                                            <div class="col-md-12"><label class="labels">Title</label><input name="quesid" type="ID" class="form-control" placeholder="ID" value="${requestScope.quesid}"></div>

                                            <div class="col-md-12"><label class="labels">Title</label><input name="content" type="nội dung" class="form-control" placeholder="nội dung" value="${requestScope.content}"></div>
                                            <div class="col-md-12"><label class="labels">Content</label><input name="title" type="title" class="form-control" placeholder="tiêu đề" value="${requestScope.title}"></div>
                                            <div class="col-md-12"><label class="labels">Tag</label><br><select name="main">
                                                            <c:forEach items="${mainlist}" var="m">
                                                                <option value="${m.tagid}" <c:if test="${m.tagid.equals(main)}">selected=""</c:if>>${m.tagid}</option>
                                                            </c:forEach>
                                                </select></div>
        ...
        <div id="edge-translate-notifier-container" class="edge-translate-notifier-center"></div></body><div id="edge-translate-notifier-container" class="edge-translate-notifier-center"></div></html>