...
<html lang="en">
    ...
    <body>
        <!-- tt-mobile menu -->
        <% ArrayList<Main_Tag> mains = (ArrayList<Main_Tag>) request.getAttribute("main");
        %>
        ...
        <main id="tt-pageContent">
            <div class="container">
                <div class="tt-wrapper-inner">
                    ...
                    <form action="ask" method="post" class="form-default form-create-topic">
                        <div class="form-group">
                            <label for="inputTopicTitle">Topic Title</label>
                            <div class="tt-value-wrapper">
                                <input type="text" name="question-title" class="form-control" id="inputTopicTitle" placeholder="Subject of your topic">
                        ...
                        <div class="pt-editor">
                            ...
                            <div class="form-group">
                                ...
                                <div ng-app="textAngularTest" ng-controller="wysiwygeditor" class="container app">
                                    ...
                                    <textarea ng-model="htmlcontent" style="width: 100%" hidden name="question-content"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tag-content" class="form-control" id="inputTopicTags" placeholder="Các tags ngăn cách nhau bằng backspace">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
