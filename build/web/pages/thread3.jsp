<%-- 
    Document   : thread3
    Created on : Feb 24, 2022, 12:51:18 PM
    Author     : Admin
--%>
    ...
    <head>
        ...
        <style>
            ...
            *{ margin: 0; padding: 0;}
            ...
            div.ng-isolate-scope:nth-child(1) {
                background-color: white;
                border: none;
            }
            ...
            .ng-pristine{
                min-height: 150px;  /* if you want Flexible textarea/div then give min-height instead of height */
                overflow: auto; 
                min-width: 100%;
                max-width: 100%;
                resize: both;
            ...
            .ng-pristine:empty:before{
                content: attr(placeholder);
            }
            .unpressed{
                fill: #666f74 !important;
            }
            .pressed{
                fill: #2172cd !important;
            }
            li:hover{
                cursor: pointer;
            }
                ...
                <div class="tt-single-topic-list">
                    ...
                    <div class="tt-item <% if (good == 1 && elem.getStatus().equals("Được bình chọn")) {
                        ...
                        <div class="tt-single-topic">
                            ...
                            <div class="tt-item-info info-bottom">
                                <li onclick="like(this)" class="tt-icon-btn u<%=elem.getCommentID()%> <%=elem.getCommentID()%>">
                                    <i class="tt-icon"><svg class="<%if (elem.isIsLike()) {
                                            out.print("pressed");
                                        }%>"><use xlink:href="#icon-like"></use></svg></i>
                                    <span class="tt-text"><%= elem.getTotalLike()%></span>
                                </li>
                                <a href="#" class="tt-icon-btn">
                                    <i class="tt-icon"><svg><use xlink:href="#icon-dislike"></use></svg></i>
                ...
                <c:if test="${sessionScope.userID != null}">    <div class="tt-wrapper-inner">
                    ...
                    <div class="tt-topic-list tt-ofset-30">
                        <div class="tt-list-search">
                            <div class="tt-title">Câu hỏi tương tự</div>
                            <!-- tt-search -->
                            <div class="tt-search">
                        ...
                        <div class="tt-list-header tt-border-bottom">
                            ...
                            <div class="tt-col-value">Lượt trả lời</div>
                            <div class="tt-col-value">Lượt thích</div>
                        </div>
                        <div class="similar">
                        <c:forEach items="${same}" var="s">
                            <div class="tt-item">
                                <div class="tt-col-avatar">
                                    <img style="    width: 50px;
                                         height: 50px;
                                         border-radius: 100%;" src="${pageContext.request.contextPath}/img/${s.getUser().img}">
                                </div>
                                ...
                                <div class="tt-col-value hide-mobile">${s.views}</div>
                                <div class="tt-col-value tt-color-select hide-mobile">${s.totalComment}</div>
                    ...
                    <div class="tt-row-btn">
                        <button onclick="loadData()" type="button" class="btn-icon js-topiclist-showmore">
                            <svg class="tt-icon">
        ...
        <main>
            ...
            <script>
                            function loadData() {
                                ...
                                var container = document.querySelector(".similar");
                                var item = container.querySelectorAll(".tt-item").length;
