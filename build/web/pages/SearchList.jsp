<%-- 
    Document   : SearchList
    Created on : Mar 8, 2022, 7:35:07 PM
    Author     : Admin
--%>
    ...
    <body>
                    ...
                    <div class="tt-wrapper-inner">
                        <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                            <li class="nav-item show">
                                <a class="nav-link active" data-toggle="tab" href="#tt-tab-01" role="tab"><span>Kết quả tìm kiếm</span></a>
                            </li>
                        ...
                        <div class="tab-pane tt-indent-none  show active" id="tt-tab-01" role="tabpanel">
                            <div class="tt-topic-list">
                                <div class="tt-list-header">
                                    ...
                                    <div style="white-space: nowrap;" class="tt-col-value-large hide-mobile"><a id="totalLike" href="search?q=${requestScope.content}&order=totalLike&sort=asc">Thích </a><i style="display: none" class="fa fa-chevron-down" aria-hidden="true"></i></div>
                                    <div style="white-space: nowrap;" class="tt-col-value-large hide-mobile"><a id="totalComment" href="search?q=${requestScope.content}&order=totalComment&sort=asc">Trả Lời </a><i style="display: none" class="fa fa-chevron-down" aria-hidden="true"></i></div>
                                    <div style="white-space: nowrap;" class="tt-col-value-large hide-mobile"><a id="totalViews" href="search?q=${requestScope.content}&order=totalViews&sort=asc">Lượt xem </a><i style="display: none" class="fa fa-chevron-down" aria-hidden="true"></i></div>
                                    <div style="white-space: nowrap;" class="tt-col-value-large hide-mobile"><a style="color: black;" id="lastActive" href="ssearch?q=${requestScope.content}&order=lastActive&sort=asc">Lần cuối </a><i style="display: none" class="fa fa-chevron-down" aria-hidden="true"></i></div>
        ...
        <script>
            ...
            if (field != null) {
                ...
                if (sort == "asc") {
                    passField = "";
                    link = "search?q=${requestScope.content}&order=" + field.id + "&sort=asc";
                    reverseLink = "q=${requestScope.content}&order=" + field.id + "&sort=desc"
                    field.setAttribute("href", link);
                    sortIcon.className = "fa fa-chevron-down";
                    sortIcon.style.display = "contents";
                } else if (sort == "desc") {
                    link = "search?q=${requestScope.content}&order=" + field.id + "&sort=desc";
                    reverseLink = "q=${requestScope.content}&order=" + field.id + "&sort=asc"
                    field.setAttribute("href", link);
            ...
            pagger(thePath, "page",<%=pageindex%>,<%=totalpage%>, 3, reverseLink, content);
            addFunc(<%=totalpage%>);
        </script>
