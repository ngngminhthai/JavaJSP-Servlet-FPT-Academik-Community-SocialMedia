                                                    ...
                                                    <div class="container rounded bg-white mt-5 mb-5">
                                                        <div class="row">
                                                            <div class="col-md-3 border-right">
                                                                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" style="width: 100%;" src="${pageContext.request.contextPath}/img/${requestScope.img}"><span class="font-weight-bold">${requestScope.username}</span><span class="text-black-50">${requestScope.email}</span><span> </span></div>
                                                            </div>
                                                            <div class="col-md-9 border-right">
                                                                <div class="p-3 py-5">
                                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                                        <h4 class="text-right">Cập nhật thông tin thành viên</h4>
                                                                    </div>
                                                                    <form method="post" action="updatemem">

                                                                        <div class="row mt-2">
                                                                            <div class="col-md-12"><label class="labels">ID</label><input name="id" type="text" class="form-control" placeholder="id" value="${requestScope.memid}"></div>

                                                                            <div class="col-md-12"><label class="labels">Username</label><input  name="username" type="text" class="form-control" placeholder="username" value="${requestScope.username}"></div>

                                                                        </div>
                                                                        <div class="row mt-3">
                                                                            <div class="col-md-12"><label class="labels">Password</label><input  name="password" type="password" class="form-control" placeholder="mật khẩu" value="${requestScope.password}"></div>
                                                                            <div class="col-md-12"><label class="labels">Email</label><input  name="email" type="email" class="form-control" placeholder="email" value="${requestScope.email}"></div>
                                                                            <div class="col-md-12"><label class="labels">Ảnh</label><input  name="img" type="text" class="form-control" placeholder="ảnh" value="${pageContext.request.contextPath}/img/${requestScope.img}"></div>
