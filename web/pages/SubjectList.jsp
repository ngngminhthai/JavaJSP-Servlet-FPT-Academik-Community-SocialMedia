<%-- 
    ...
    Created on : Mar 12, 2022, 2:52:56 PM
    Author     : Admin
--%>
        ...
        <main id="tt-pageContent">
            <div class="tt-custom-mobile-indent container">
                <div class="tt-categories-title">
                    <div class="tt-title">Môn học</div>
                    <div class="tt-search">
                        <form class="search-wrapper">
                            <div class="search-form">
                                <input type="text" class="tt-search__input" placeholder="Tìm kiếm môn học">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="tt-item">
                                    ...
                                    <div class="tt-item-layout">
                                        ...
                                        <div class="innerwrapper">
                                            <h6 class="tt-title">Tương tự</h6>
                                            <ul class="tt-list-badge">
                                                <c:forEach items="${s.tags}" var="t">
                                                    <li><a href="#"><span class="tt-badge">${t}</span></a></li>
                                                        </c:forEach>
                                            </ul>
                                        </div>
