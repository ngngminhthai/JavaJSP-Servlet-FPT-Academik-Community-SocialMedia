...
public class FindComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FindComment</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FindComment at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int page = comdb.findComment(comid, quesid);
        HttpSession session = request.getSession();
        session.setAttribute("cid", comid);
        response.sendRedirect("thread?questionid=" + quesid + "&page=" + page + "&cid=" + comid + "");
    }

//    public static void main(String[] args) {
//        FindComment f = new FindComment();
//        CommentDBContext comdb = new CommentDBContext();
//        int page = comdb.findComment(58, 17);
